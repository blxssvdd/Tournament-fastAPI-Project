...
@users_route.post("/", status_code=status.HTTP_201_CREATED, tags=["Users"], summary="Create user")
...
@users_route.post("/token/", status_code=status.HTTP_202_ACCEPTED, response_model=TokenModel, tags=["Users"], summary="Login")
...
@users_route.get("/", status_code=status.HTTP_202_ACCEPTED, response_model=UserModelResponse, tags=["Users"], summary="Get user")
